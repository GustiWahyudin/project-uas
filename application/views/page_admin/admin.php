        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="index.html">
              ...
              <span class="menu-title">Halaman Toko</span>
            </a>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Nama</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Alamat</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">No. Telp</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Rainbow Cake</a></li>      
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Red Velvet</a></li>
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Cheese Cakes</a></li>
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Black Forest Cake</a></li>
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Lego Cake</a></li>
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Minion Cake</a></li>                
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Unicorn Cake</a></li>
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Doraemon Cake</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
                      ...
                      <div class="row align-items-center h-100">
                        <div class="col-md-4">
                          <figure class="avatar mx-auto mb-4 mb-md-0">
                            <img src="<?= base_url('Assets/'); ?>img/faces/face20.jpg" alt="avatar">
                          </figure>
                        </div>
                        <div class="col-md-8">
